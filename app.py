...
def load_questions():
    try:
        df = pd.read_csv("https://raw.githubusercontent.com/thhoaminh2025-hm/chatbox-tracnghiem/refs/heads/main/questions.csv", encoding="utf-8")
    except:
        df = pd.read_csv("https://raw.githubusercontent.com/thhoaminh2025-hm/chatbox-tracnghiem/refs/heads/main/questions.csv", encoding="latin-1")
    return df
